...
def fit_new(self, env, nb_steps, action_repetition=1, callbacks=None, verbose=1,
            ...
            nb_max_episode_steps=None, arr=None, difficulty=2):
    difficulty = 0
    ...
    try:
        while self.step < nb_steps:
            if observation is None:  # start of a new episode
                ...
                self.reset_states()
                observation = deepcopy(env.reset(difficulty=difficulty))
...
def test_new(self, env, nb_episodes=1, action_repetition=1, callbacks=None, visualize=True,
             ...
             start_step_policy=None, verbose=1, arr=None, difficulty=2):
    # difficulty = 0
    if not self.compiled:
